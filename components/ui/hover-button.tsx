    ...
    return (
      <button
        ...
        className={cn(
          ...
          "backdrop-blur-lg bg-[rgba(0,0,0,0.3)]",
          "cursor-pointer overflow-hidden",
          "before:content-[''] before:absolute before:inset-0",
          "before:rounded-[inherit] before:pointer-events-none",
          "before:z-[1]",
          "before:shadow-[inset_0_0_0_1px_rgba(250,204,21,0.3),inset_0_0_16px_0_rgba(250,204,21,0.15),inset_0_-3px_12px_0_rgba(250,204,21,0.2),0_1px_3px_0_rgba(0,0,0,0.50),0_4px_12px_0_rgba(0,0,0,0.45)]",
        ...
        {...props}
        style={{
          "--circle-start": "var(--tw-gradient-from, #fbbf24)",
          "--circle-end": "var(--tw-gradient-to, #f59e0b)",
